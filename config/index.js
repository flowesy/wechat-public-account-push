export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx02fcaceafa66d797",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "ef2c04804d416f029afacc45166c22d7",
  ...
  USERS: [
    {
      ...
      id: "o2Hza5-dDsihIEFEIM1VN_WvFe2A",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "QF3zHZk_-OHUhklcmg76mrWgW8fpwZu3a1Sf2TYECg8",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
    ...
    },
    {
      ...
      name: "武继东",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "o2Hza55-dhD_I93Zundl9gx2I99k",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "QF3zHZk_-OHUhklcmg76mrWgW8fpwZu3a1Sf2TYECg8",
      // 所在省份
      province: "北京",
  ...
  CALLBACK_TEMPLATE_ID: "	UzFpaTuhMmMhUCk6was0oCzVImxqpYQ7ABp_96gDzCo",
